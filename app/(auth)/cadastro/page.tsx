    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#FAFAF9', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <div style={{ color: '#A8A29E', fontSize: '13px' }}>Crie sua conta gratuita</div>
        </div>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '14px', border: '1px solid #E7E5E4', padding: '28px' }}>
          <form onSubmit={handleCadastro} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            {[
              ...
              <div key={label}>
                <label style={{ display: 'block', fontSize: '11px', fontWeight: 700, color: '#A8A29E', marginBottom: '5px', letterSpacing: '.3px' }}>{label}</label>
                <input
                  type={type}
                  value={value}
        ...
        <p style={{ textAlign: 'center', marginTop: '20px', fontSize: '13px', color: '#78716C' }}>
          Já tem conta?{' '}
          <Link href="/login" style={{ color: '#EF9F27', fontWeight: 700, textDecoration: 'none' }}>Entrar</Link>
        </p>
      </div>
    </div>
  )
